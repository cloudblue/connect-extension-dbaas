...
describe('CreateEditDialog', () => {
  ...
  describe('#computed', () => {
    ...
    describe('#allowSaving', () => {
      ...
      beforeEach(() => {
        setContext = (isEdit, acceptTermsAndConds, name, contact, region) => {
          context = {
            isEdit,
            acceptTermsAndConds,
      ...
      it.each([
        [false, true, 'name', 'contact', 'region', ['toBe', true]],
        [false, false, null, null, null, ['toBe', false]],
        [false, true, null, null, null, ['toBe', false]],
        [false, true, 'name', null, null, ['toBe', false]],
        [false, true, 'name', 'contact', null, ['toBe', false]],
        [false, false, 'name', 'contact', 'region', ['toBe', false]],
        [false, false, null, 'contact', 'region', ['toBe', false]],
        [false, false, null, null, 'region', ['toBe', false]],

        [true, false, 'name', 'contact', null, ['toBe', true]],
        [true, false, null, 'contact', null, ['toBe', false]],
        [true, false, null, null, null, ['toBe', false]],
        [true, false, 'name', null, null, ['toBe', false]],
      ])(
        'When isEdit=%j, acceptTermsAndConds=%j, name=%j, contact=%j, region=%j should "%j"',
        (isEdit, acceptTermsAndConds, name, contact, region, spec) => {
          const [satisfies, condition] = spec;
